    ...
    init(manager){
        ...
        <div class="flex-center">
            <div class="mobile-wrapper">
                <button class="mobile-back-button"><image src="src/assets/images/back.png" width=25px></button>
                <p class="mobile-login-text" style="margin-bottom:50px;">회원가입</p>
                <div class="text-center" style="position:relative;">
                    <input type="email" class="mobile-email-input" placeholder="이메일" required>
                    <button class="mobile-email-auth-button">인증번호 전송</button>
                </div>
                <p class="mobile-warning-text">⚠️  중복 이메일입니다. 다시 입력해주세요.</p>

                <div style="position:relative;">
                    <input class="mobile-email-input" style="width:55%; margin-left:6.511%;" placeholder="인증번호" required>
                    <button class="mobile-email-auth-button" style="left:51%;right:unset;width:20%;padding:0;">확인</button>
                    <button class="mobile-email-auth-button" style="width:20%;padding:0;">재전송</button>
                </div>
                <p class="mobile-warning-text">⚠️  인증번호가 틀렸습니다. 다시 시도해주세요.</p>
                ...
                <p class="mobile-warning-text hidden" id="warnPw">⚠️  비밀번호가 일치하지 않습니다.</p>
        ...
        this.addEvent("#pw1","input",comparePassword)
        this.addEvent("#pw2","input",comparePassword)
